...
import com.example.elasticagent.executors.AgentNotFoundException;
...
public interface AgentInstances<T> {
    ...
    /**
     * This message is sent via from the {@link com.example.elasticagent.executors.ServerPingRequestExecutor}
