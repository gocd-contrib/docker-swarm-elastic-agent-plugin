...
public class GetPluginConfigurationExecutor implements RequestExecutor {
    ...
    public static final Field DOCKER_URL = new NonBlankField("docker_uri", "Docker URI", null, false, "3");
    ...
    public static final Field ENABLE_PRIVATE_REGISTRY_AUTHENTICATION = new NonBlankField("enable_private_registry_authentication", "Use Private Registry", "false", false, "8");
